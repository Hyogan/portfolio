...
const Contact = () => {
    return (
        <section className="w-full flex flex-col items-center py-16 gap-12 min-h-[70vh]">
            ...
            <a
                ...
                className="bg-secondary text-white text-lg font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-white hover:text-primary transition-all duration-300"
            >
                Contact Me
            </a>
        </section>
